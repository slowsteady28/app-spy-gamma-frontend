...
function PutNetOIChart({
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8000/data/pw1-net-oi?lookback=${lookback}`)
      .then((res) => setData(res.data.data))
      .catch((err) => console.error("Error loading PW1 OI data", err));
  }, [lookback]);
