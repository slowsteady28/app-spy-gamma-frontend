...
import AbsGamma2WallChart from "./AGS2HisGammaChart";
import AbsGamma2NetOIChart from "./AGS2NetOIChart";
import AGS2CallPutGammaChart from "./AGS2CallPutGammaChart";
import AbsGamma2DurationChart from "./AGS2DurationChart";

const AbsGamma2AppReady = () => {
        ...
        <Col xs={12} className="d-flex">
          <Card className="border-0 shadow-sm bg-body-emphasis d-flex flex-column h-100 w-100">
            <Card.Header className="bg-transparent border-0 pb-0 d-flex align-items-center gap-2">
              ...
              <span className="fw-semibold">2th Largest Wall</span>
            </Card.Header>
            <Card.Body>
              ...
              <Row className="g-4">
                <Col xs={12}>
                  <AbsGamma2WallChart lookback={lookback} />
                </Col>
                <Col xs={12}>
                  <AbsGamma2NetOIChart lookback={lookback} />
                </Col>
                <Col xs={12}>
                  <AGS2CallPutGammaChart lookback={lookback} />
                </Col>
                <Col xs={12}>
                  <AbsGamma2DurationChart lookback={lookback} />
                </Col>
              </Row>
            </Card.Body>
          </Card>
...
export default AbsGamma2AppReady;
