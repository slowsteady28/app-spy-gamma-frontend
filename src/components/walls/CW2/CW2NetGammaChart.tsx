...
function CW2NetGammaChart({ lookback }: PutNetGammaChartProps) {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        console.log("cW2 Net Gamma Data:", res.data);
        setData(res.data);
      })
      .catch((err) => console.error("Error loading cW2 net gamma data", err));
  }, [lookback]);
