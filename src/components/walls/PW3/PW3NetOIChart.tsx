...
function PW3NetOIChart({
  ...
  useEffect(() => {
    axios
      .get(`${apiBaseUrl}/data/pw3-net-oi?lookback=${lookback}`)
      .then((res) => setData(res.data.data))
      .catch((err) => console.error("Error loading PW3 OI data", err));
  }, [lookback]);
