...
function CW3NetOIChart({
  ...
  useEffect(() => {
    axios
      .get(`${apiBaseUrl}/data/cw3-net-oi?lookback=${lookback}`)
      .then((res) => setData(res.data.data))
      .catch((err) => console.error("Error loading cW3 Net OI", err));
  }, [lookback]);
  ...
  return (
    ...
    >
          ...
          >
            {[
              ...
              <button
                ...
                onClick={() => setVisible(value as "both" | "call" | "put")}
              >
                {label}
              </button>
            ))}
      ...
      <Plot
        ref={chartRef}
        data={traces as Plotly.Data[]} // ✅ force TS to accept traces
        layout={
          {
            height: 310,
