...
function CW4NetGammaChart({ lookback }: PutNetGammaChartProps) {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        console.log("cW4 Net Gamma Data:", res.data);
        setData(res.data);
      })
      .catch((err) => console.error("Error loading cW4 net gamma data", err));
  }, [lookback]);
