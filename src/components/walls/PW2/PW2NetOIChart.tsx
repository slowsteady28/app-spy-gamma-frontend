...
function PW2NetOIChart({
  ...
  useEffect(() => {
    axios
      .get(`${apiBaseUrl}/data/pw2-net-oi?lookback=${lookback}`)
      .then((res) => setData(res.data.data))
      .catch((err) => console.error("Error loading PW2 OI data", err));
  }, [lookback]);
