...
type CW1MidTermExpChartProps = {
  lookback: number;
};

const CW1MidTermExpChart: React.FC<CW1MidTermExpChartProps> = ({
  lookback,
}) => {
  ...
  useEffect(() => {
    axios
      .get(`${apiBaseUrl}/data/cw1-mid-term-exp?lookback=${lookback}`)
      .then((res) => {
...
export default CW1MidTermExpChart;
