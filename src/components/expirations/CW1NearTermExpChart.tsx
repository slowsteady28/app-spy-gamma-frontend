...
type CW1NearTermExpChartProps = {
  lookback: number;
};

const CW1NearTermExpChart: React.FC<CW1NearTermExpChartProps> = ({
  lookback,
}) => {
  ...
  useEffect(() => {
    axios
      .get(`${apiBaseUrl}/data/cw1-near-term-exp?lookback=${lookback}`)
      .then((res) => {
...
export default CW1NearTermExpChart;
