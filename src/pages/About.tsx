    ...
    >
      ...
      >
        ...
        <p style={{ color: "#495057", fontSize: "1.1rem" }}>
          ...
          and a relentless drive to understand how options positioning shapes
          the market. I didn’t come from a traditional trading background. I
          learned everything you see here the hard way—through self-study, trial
          and error, and diving deep into the insights shared by some of the
          best educators in the field.
        </p>
        <p style={{ color: "#495057", fontSize: "1.1rem" }}>
        ...
        >
          <li>
            <strong style={{ color: mainColor }}>Hard Work:</strong> There are
            no shortcuts. Every chart, every model, every backtest on this site
          ...
          <li>
            <strong style={{ color: mainColor }}>Sacrifice:</strong> Real
            learning costs time, energy, and discipline. I’ve put in the hours
        ...
        <p style={{ color: "#495057", fontSize: "1.1rem" }}>
          I’m always open to collaboration, learning from others, and giving
          back where I can. If you’re a trader, educator, or just someone who
          shares this passion for decoding markets—I’d love to connect.
        </p>
